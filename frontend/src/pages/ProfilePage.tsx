      ...
      <div className="glass-card p-12 mb-16 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 relative z-10">
          ...
          <div className="text-center md:text-left">
            <h1 className="text-4xl font-body font-black mb-3 tracking-normal">Alchemist {formatAddress(address || '')}</h1>
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              <div className="px-4 py-2 rounded-xl bg-white/5 border border-white/5 flex items-center gap-2">
                <span className="text-[10px] uppercase tracking-[0.12em] text-white/30 font-semibold">Total Spells</span>
                <span className="font-mono font-bold text-white">42</span>
              </div>
              <div className="px-4 py-2 rounded-xl bg-white/5 border border-white/5 flex items-center gap-2">
                <span className="text-[10px] uppercase tracking-[0.12em] text-white/30 font-semibold">Trading Volume</span>
